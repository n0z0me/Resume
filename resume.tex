...
\section{Experience}
\textbf{\color{subtitle}SoftBank} \hspace{1mm} { - April, 2019 - Present}\\
Full Stack Engineer.\\

\textbf{\color{subtitle}CiNet} \hspace{1mm} { - June, 2018 - March, 2019}\\
Research Trainee. Main area was EEG-BMI.\\

\textbf{\color{subtitle}SoftBank} \hspace{1mm} {\color{subtitle} - August, 2017}\\
Summer Internship. Brainstorming new application ideas and make mocks. And, functional verification of SDN Switch.\\

\textbf{\color{subtitle}freee} \hspace{1mm} {\color{subtitle} - September, 2017}\\
Summer Internship. SRE Engineer.\\

\textbf{\color{subtitle}Colt Technology} \hspace{1mm} {\color{subtitle} - August, 2015}\\
...
{\small\faDesktop} \hspace{0.9mm} \href{https://www.LaTeXTemplates.com}{https://www.LaTeXTemplates.com}\\ % Website
