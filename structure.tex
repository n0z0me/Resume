...
\columnratio{0.25,0.75} % The relative ratios of the two columns in the CV
...
\setmainfont{Helvetica}[ % Make the default font EBGaramond
...
\definecolor{text}{HTML}{2b2b2b} % Main document font color, off-black
\definecolor{name}{HTML}{3498DB} % Name color
\definecolor{subtitle}{HTML}{626567} % Subsection Title color
\definecolor{headings}{HTML}{3498DB} % Light Blue color for headings
\definecolor{shade}{HTML}{FFFFFF} % Peach colour for the contact information box
\definecolor{linkcolor}{HTML}{3498DB} % 25% desaturated headings colour for links
% Other color options: shade=B9D7D9 and linkcolor=A40000; shade=D4D7FE and linkcolor=FF0080

\color{text} % Set the default text color for the whole document to the color defined as 'text' above
